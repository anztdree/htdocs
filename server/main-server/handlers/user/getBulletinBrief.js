...
(function () {
    ...
    function handleGetBulletinBrief(request, callback) {
        ...
        try {
            ...
            // ── DATA RETRIEVAL ──
            console.groupCollapsed('%c📦 Data Retrieval', 'color:#0277BD;font-weight:bold;');
            ...
            _dataSteps.push({ step: 'getBulletins', status: '✅ OK', total: bulletins.length, active: briefCount });
            console.table(_dataSteps);
            console.groupEnd();
            ...
            console.log('   · 📋 bulletinCount: ' + briefCount);
            console.log('   · 📦 totalStored: ' + bulletins.length);
            console.groupEnd();
