...
(function () {
    ...
    function handleReadNew(request, callback) {
        ...
        // ═══ PROCESSING ═══
        console.groupCollapsed('%c📦 Shop ReadNew Processing', 'color:#0277BD;font-weight:bold;');
        console.log('userId:', userId, 'marketType:', marketType);
        ...
        console.log('📋 Key Data:', {
            totalHeroes: Object.keys(heros).length,
            newHeroes: heroCount
        });
        console.groupEnd();
