...
(function () {
    ...
    function handleMerge(request, callback) {
        ...
        var _validationChecks = [
            ...
            { check: 'pieces present', pass: !!(request && request.pieces) && Array.isArray(request.pieces) }
        ];
    ...
    function _handleMergeImpl(request, callback) {
        ...
        console.log('📋 Key Data:', {
            weaponsProduced: allWeapons.length,
            pieceTypesConsumed: Object.keys(allChangeItems).length
        });
        console.groupEnd();
