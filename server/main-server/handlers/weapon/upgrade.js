...
(function () {
    ...
    function handleWeaponUpgrade(request, callback) {
        ...
        var _validationChecks = [
            { check: 'userId present', pass: !!(request && request.userId) },
            { check: 'heroId present', pass: !!(request && request.heroId) },
            { check: 'weaponId present', pass: !!(request && request.weaponId) }
        ];
        ...
        try {
            ...
            // ═══ PROCESSING ═══
            console.groupCollapsed('%c📦 Weapon Upgrade Processing', 'color:#0277BD;font-weight:bold;');
            console.log('userId:', userId, 'heroId:', heroId, 'weaponId:', weaponId);
            ...
            console.log('📋 Key Data:', {
                ...
                power: totalAttrItems && totalAttrItems['21'] ? totalAttrItems['21']._num : null,
