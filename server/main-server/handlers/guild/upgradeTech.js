...
(function () {
    ...
    function handleUpgradeTech(request, callback) {
        ...
        var _valChecks = [];
        _valChecks.push({ '#': 1, Check: 'userId', Status: userId ? '✅ ' + userId : '⚠️ MISSING' });
        _valChecks.push({ '#': 2, Check: 'techType', Status: techType ? '✅ ' + techType : '⚠️ MISSING' });
        _valChecks.push({ '#': 3, Check: 'techId', Status: techId ? '✅ ' + techId : '⚠️ MISSING' });
        ...
        var _respAudit = [];
        _respAudit.push({ Field: '_level', Value: response._level, Status: '✅' });
        _respAudit.push({ Field: '_totalLevel', Value: response._totalLevel, Status: '✅' });
        _respAudit.push({ Field: '_changeInfo', Value: 'SET', Status: '✅' });
        _respAudit.push({ Field: '_attrs', Value: 'SET', Status: '✅' });
        _respAudit.push({ Field: '_totalCost', Value: 'SET', Status: '✅' });
        _respAudit.push({ Field: '_updateAttrs', Value: Object.keys(response._updateAttrs).length + ' heroes', Status: '✅' });
