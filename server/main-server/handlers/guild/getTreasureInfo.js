...
(function () {
    ...
    function handleGetTreasureInfo(request, callback) {
        ...
        _valChecks.push({ '#': 2, Check: 'guildUUID', Status: guildUUID ? '✅ ' + guildUUID : '⚠️ MISSING' });
        ...
        var _respAudit = [];
        _respAudit.push({ Field: '_treasure._matchRet', Value: treasure._matchRet, Status: '✅' });
        _respAudit.push({ Field: '_memberLastArenaTeam', Value: Object.keys(memberLastArenaTeam).length + ' entries', Status: '✅' });
