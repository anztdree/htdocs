...
(function () {
    ...
    function handleGetGuildList(request, callback) {
        ...
        _valChecks.push({ '#': 2, Check: 'pagination', Status: '✅ page=' + curPage + '/' + pageLen });
        ...
        var _respAudit = [];
        _respAudit.push({ Field: '_guilds', Value: pageGuilds.length + '/' + allGuilds.length, Status: '✅' });
        _respAudit.push({ Field: '_totalCount', Value: totalCount + ' pages', Status: '✅' });
        _respAudit.push({ Field: 'curPage', Value: curPage + '/' + totalCount, Status: '✅' });
