...
(function () {
    ...
    function handleSplitHero(request, callback) {
        ...
        if (!heroPieceConfig) {
            ...
            _validationChecks.push({ check: 'Config', status: '❌ FAIL', info: 'heroPiece.json not found' });
            console.table(_validationChecks);
            console.groupEnd();
        ...
        _validationChecks.push({ check: 'Config', status: '✅ PASS', info: 'heroPiece.json loaded' });
        ...
        if (splitCount === 0) {
            ...
            _processSteps.push({ step: 'Split Heroes', status: '❌ FAIL', info: 'no heroes split' });
            ...
            console.groupCollapsed('%c📤 Response Build & Audit', 'color:#1565C0;font-weight:bold;');
            console.log('   ⏱️ Elapsed: ' + _elapsed + 'ms');
            console.log('   📋 Result: ERROR (no heroes split)');
            console.groupEnd();
        ...
        _processSteps.push({ step: 'Split Heroes', status: '✅', info: splitCount + ' heroes split' });
        _processSteps.push({ step: 'Piece Rewards', status: '✅', info: Object.keys(pieceRewards).length + ' piece types' });
        ...
        console.log('   ✂️ Heroes Split: ' + splitCount);
        console.log('   🎁 Piece Types: ' + Object.keys(pieceRewards).length);
