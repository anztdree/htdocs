...
(function () {
    ...
    function handleBuyLessonFund(request, callback) {
        ...
        try {
            ...
            console.log('   ✅ Fund purchased, prePayRet built');
            console.groupEnd();
            ...
            console.table([
                { Field: 'prePayRet.errorCode', Value: 0, Note: 'success' },
                { Field: 'price', Value: price + ' USD', Note: 'fund cost' },
                { Field: '_buyFund', Value: true, Note: 'server state set' },
                { Field: 'notify', Value: 'payFinish', Note: 'client notification' }
            ]);
            console.groupEnd();
