...
(function () {
    ...
    function handleGain(request, callback) {
        ...
        console.table([
            { Field: '_changeInfo.items', Value: Object.keys(ci).length, Note: 'item balances' },
            { Field: '_lastGainTime', Value: lastT, Note: 'OLD value for client display' },
            { Field: '_exCount', Value: exCount, Note: 'random drop count' },
