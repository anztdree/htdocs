...
(function () {
    ...
    function handleGetChapterReward(request, callback) {
        ...
        if (!chapterId) {
            ...
            _valChecks.push({ '#': 2, Check: 'chapterId', Status: '✅ OK (' + chapterId + ')' });
        }
        ...
        console.log('   ✅ Rewards granted and persisted');
        console.groupEnd();
        ...
        console.table([
            { Field: 'chapterId', Value: chapterId, Note: 'reward claimed' },
            { Field: 'reward1', Value: reward1Id + 'x' + reward1Num, Note: 'bal=' + newBalance1 },
            { Field: 'reward2', Value: reward2Id + 'x' + reward2Num, Note: 'bal=' + newBalance2 },
