...
(function () {
    ...
    function handleSummonEnergy(request, callback) {
        ...
        // ── Load user data ──
        console.groupCollapsed('%c📦 Data Load & Summon Process', 'color:#0277BD;font-weight:bold;');
        ...
        console.log('   ✅ Energy summon complete');
        console.groupEnd();
        ...
        console.table([
            ...
            { Field: 'consumed', Value: threshold, Note: 'energy used' },
