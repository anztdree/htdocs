...
(function () {
    ...
    function handleActiveSuperSkill(request, callback) {
        ...
        console.table([
            { Field: 'skillId', Value: skillId, Note: 'activated skill' },
            { Field: 'quality', Value: (skillEntry && skillEntry.quality) || '-', Note: 'skill quality' },
            { Field: 'newKey', Value: newKey, Note: 'storage key' },
