...
(function () {
    ...
    function handleRefresh(request, callback) {
        ...
        var _validationChecks = [
            { check: 'userId present', pass: !!request.userId },
            { check: 'refreshType valid', pass: [1,2,3].indexOf(Number(request.refreshType)) !== -1 }
        ];
        ...
        try {
            ...
            if (!savedData) {
                ...
                console.log('❌ Error: savedData not found');
                console.groupEnd();
                callback({}, 1);
                return;
            }
            ...
            // ═══ PROCESSING ═══
            console.groupCollapsed('%c📦 Market Refresh Processing', 'color:#0277BD;font-weight:bold;');
            ...
            console.log('📋 Key Data:', {
                ...
                freeRefreshTimes: mState._freeRefreshTimes,
                diamondRefreshCount: mState._diamondRefreshCount,
                hasCost: hasCost,
