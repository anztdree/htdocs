...
(function () {
    ...
    function handleGetInfo(request, callback) {
        ...
        try {
            // ═══ PROCESSING ═══
            console.groupCollapsed('%c📦 Market GetInfo Processing', 'color:#0277BD;font-weight:bold;');
            ...
            console.log('📋 Key Data:', {
                itemCount: Object.keys(marketItems).length,
                freeRefreshTimes: freeRefreshTimes,
                diamondRefreshCount: diamondRefreshCount
            });
            console.groupEnd();
