...
(function () {
    ...
    function _handleGetInfoImpl(request, callback) {
        ...
        console.table([
            { Field: 'curLevel', Value: info._curLevel, Note: 'current level' },
            { Field: 'curEnemy', Value: info._curEnemy, Note: 'current enemy' },
            { Field: 'heroes', Value: heroCount, Note: 'hero count' },
            { Field: 'enemies', Value: enemyCount, Note: 'enemy count' },
            { Field: 'routing', Value: heroCount === 0 ? 'setTeam' : 'battle', Note: 'client route' },
